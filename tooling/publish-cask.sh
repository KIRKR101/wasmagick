...
RUBY+="  caveats <<~EOS\n"
RUBY+="    The app is unsigned, so macOS may report it as \"damaged\" on first launch.\n"
RUBY+="    Fix it by removing the quarantine flag:\n\n"
RUBY+="      xattr -dr com.apple.quarantine \"/Applications/${APP_NAME}.app\"\n"
RUBY+="  EOS\n\n"
RUBY+="  zap trash: [\n"
